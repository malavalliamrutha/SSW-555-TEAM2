...
class TestDates(unittest.TestCase):
	...
	def test_unique_first_names_in_families(self):
		individuals = {'I1': {'name': 'John', 'birth_date': '1980-01-01'},
						'I2': {'name': 'John', 'birth_date': '1985-01-01'},
						'I3': {'name': 'Mary', 'birth_date': '1990-01-01'}}
		families = {'F1': {'husband_id': 'I1', 'wife_id': 'I3', 'children_ids': []},
					'F2': {'husband_id': 'I2', 'wife_id': 'I3', 'children_ids': []}}
		is_unique = GedcomUserstories.is_unique_first_names_in_families(individuals, families)
		self.assertTrue(is_unique, "Not all first names in families are unique")
	...
	def test_corresponding_entries(self):
		...
		individuals = [1, 2, 3]
		families = [4, 5, 6]
		self.assertTrue(has_corresponding_entries(individuals, families),
	...
	def test_individual_ages(self):
		self.assertNotEqual(individual_ages(n1,b1), 1)
		self.assertEqual(individual_ages(n2, b2), -1)
		self.assertEqual(individual_ages(n3, b3), -1)
		self.assertNotEqual(individual_ages(n4, b4), 1)
		self.assertEqual(individual_ages(n5, b5), -1)
        
	def test_living_married(self):
		people = [
			{"name": "John", "age": 30, "is_married": True, "is_alive": True},
			{"name": "Jane", "age": 28, "is_married": True, "is_alive": True},
			{"name": "Bob", "age": 35, "is_married": False, "is_alive": True},
			{"name": "Alice", "age": 40, "is_married": True, "is_alive": False},
		]
		expected_output = [{"name": "John", "age": 30, "is_married": True, "is_alive": True},
							{"name": "Jane", "age": 28, "is_married": True, "is_alive": True}]
		self.assertEqual(GedcomUserstories.list_living_married(people, expected_output), expected_output)

	def test_list_deceased_individuals(self):
		individuals = [
			{'name': 'John', 'is_deceased': True, 'death_date': '2022-01-01'},
			{'name': 'Mary', 'is_deceased': False},
			{'name': 'Bob', 'is_deceased': True, 'death_date': '2023-03-15'},
			{'name': 'Jane', 'is_deceased': True, 'death_date': '2020-12-31'},
		]
		expected_output = [('John', '2022-01-01'), ('Bob', '2023-03-15'), ('Jane', '2020-12-31')]
		result = GedcomUserstories.list_deceased(individuals)
